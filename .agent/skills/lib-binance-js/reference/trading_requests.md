...
Source: https://developers.binance.com/docs/binance-spot-api-docs/websocket-api/trading-requests
...
Supported values: [Order Types](/docs/binance-spot-api-docs/websocket-api/trading-requests#order-type) Note that `MARKET` orders using `quoteOrderQty` are not supported.
