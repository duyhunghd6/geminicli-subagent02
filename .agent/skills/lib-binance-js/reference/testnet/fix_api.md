...
`1` - [TEST\_REQUEST](/docs/binance-spot-api-docs/testnet/fix-api#testrequest)  
  
`3` - [REJECT](/docs/binance-spot-api-docs/testnet/fix-api#reject)  
  
`5` - [LOGOUT](/docs/binance-spot-api-docs/testnet/fix-api#logout)  
  
`8` - [EXECUTION\_REPORT](/docs/binance-spot-api-docs/testnet/fix-api#executionreport)  
  
`9` - [ORDER\_CANCEL\_REJECT](/docs/binance-spot-api-docs/testnet/fix-api#ordercancelreject)  
  
`A` - [LOGON](/docs/binance-spot-api-docs/testnet/fix-api#logon-main)  
  
`D` - [NEW\_ORDER\_SINGLE](/docs/binance-spot-api-docs/testnet/fix-api#newordersingle)  
  
`E` - [NEW\_ORDER\_LIST](/docs/binance-spot-api-docs/testnet/fix-api#neworderlist)  
  
`F` - [ORDER\_CANCEL\_REQUEST](/docs/binance-spot-api-docs/testnet/fix-api#ordercancelrequest)  
  
`N` - [LIST\_STATUS](/docs/binance-spot-api-docs/testnet/fix-api#liststatus)  
  
`q` - [ORDER\_MASS\_CANCEL\_REQUEST](/docs/binance-spot-api-docs/testnet/fix-api#ordermasscancelrequest)  
  
`r` - [ORDER\_MASS\_CANCEL\_REPORT](/docs/binance-spot-api-docs/testnet/fix-api#ordermasscancelreport)  
  
`XCN` - [ORDER\_CANCEL\_REQUEST\_AND\_NEW\_ORDER\_SINGLE](/docs/binance-spot-api-docs/testnet/fix-api#ordercancelrequestandnewordersingle)  
  
`XLQ` - [LIMIT\_QUERY](/docs/binance-spot-api-docs/testnet/fix-api#limitquery)  
  
`XLR` - [LIMIT\_RESPONSE](/docs/binance-spot-api-docs/testnet/fix-api#limitresponse)  
  
`B` - [NEWS](/docs/binance-spot-api-docs/testnet/fix-api#news)  
  
`x`\- [INSTRUMENT\_LIST\_REQUEST](/docs/binance-spot-api-docs/testnet/fix-api#instrumentlistrequest)  
  
`y` - [INSTRUMENT\_LIST](/docs/binance-spot-api-docs/testnet/fix-api#instrumentlist)  
  
`V` - [MARKET\_DATA\_REQUEST](/docs/binance-spot-api-docs/testnet/fix-api#marketdatarequest)  
  
`Y` - [MARKET\_DATA\_REQUEST\_REJECT](/docs/binance-spot-api-docs/testnet/fix-api#marketdatarequestreject)  
  
`W` - [MARKET\_DATA\_SNAPSHOT](/docs/binance-spot-api-docs/testnet/fix-api#marketdatasnapshot)  
  
`X` - [MARKET\_DATA\_INCREMENTAL\_REFRESH](/docs/binance-spot-api-docs/testnet/fix-api#marketdataincrementalrefresh)  
  
`XAK` - [ORDER\_AMEND\_KEEP\_PRIORITY\_REQUEST](/docs/binance-spot-api-docs/testnet/fix-api#orderamendkeeppriorityrequest)  
  
`XAR` - [ORDER\_AMEND\_REJECT](/docs/binance-spot-api-docs/testnet/fix-api#orderamendreject)
...
API error code (see [Error Codes](/docs/binance-spot-api-docs/testnet/errors)).
...
Signature. [How to sign Logon`<A>` request](/docs/binance-spot-api-docs/testnet/fix-api#signaturecomputation).
...
Please refer to [Response Mode](/docs/binance-spot-api-docs/testnet/fix-api#responsemode).
...
See the [table](/docs/binance-spot-api-docs/testnet/fix-api#ordertype) to understand supported order types and the required fields to use them.  
...
Possible values: `4` - PRICE\_MOVEMENT
...
Activation price for contingent orders. See [table](/docs/binance-spot-api-docs/testnet/fix-api#ordertype)
...
Used to differentiate between StopLoss and TakeProfit orders. See [table](/docs/binance-spot-api-docs/testnet/fix-api#ordertype).  
...
Sets this order list as an [OPO](/docs/binance-spot-api-docs/faqs/opo) when set to `true`.
...
Corresponds to the [LOT\_SIZE](/docs/binance-spot-api-docs/testnet/filters#lot_size) filter
...
Corresponds to the [MARKET\_LOT\_SIZE](/docs/binance-spot-api-docs/testnet/filters#market_lot_size) filter
...
Corresponds to the [PRICE](/docs/binance-spot-api-docs/testnet/filters#price) filter
...
ID of the invalid [MarketDataRequest`<V>`](/docs/binance-spot-api-docs/testnet/fix-api#marketdatarequest)
...
API Error code. See [Errors](/docs/binance-spot-api-docs/testnet/errors)
...
ID of the [MarketDataRequest`<V>`](/docs/binance-spot-api-docs/testnet/fix-api#marketdatarequest) that activated this subscription
...
Only present in [Diff. Depth Stream](/docs/binance-spot-api-docs/testnet/fix-api#diffdepthstream).  
...
Only present in [Diff. Depth Stream](/docs/binance-spot-api-docs/testnet/fix-api#diffdepthstream) and [Individual Symbol Book Ticker Stream](/docs/binance-spot-api-docs/testnet/fix-api#symbolbooktickerstream).  
...
FIX SBE (Simple Binary Encoding) can be used instead of FIX with the [spot\_fix\_testnet\_latest.xml](https://github.com/binance/binance-spot-api-docs/blob/master/sbe/schemas/spot_fix_testnet_latest.xml) schema file.
